...
export const metadata: Metadata = {
    ...
    description: "Besök Salong LaVie på Västerbrogatan 1 i Borås. Öppet mån-fre 09-19, lör 09-16. Ring och boka tid: 070-767 87 79. Din frisör i centrala Borås.",
    ...
    openGraph: {
        ...
        description: "Västerbrogatan 1, Borås. Ring: 070-767 87 79. Öppet mån-fre 09-19.",
